...
let locHue: WebGLUniformLocation | null = null;
let locXOffset: WebGLUniformLocation | null = null;
let locSpeed: WebGLUniformLocation | null = null;
let locIntensity: WebGLUniformLocation | null = null;
let locSize: WebGLUniformLocation | null = null;
...
const initWebGL = () => {
  ...
  locResolution = gl.getUniformLocation(program, 'iResolution');
  locTime = gl.getUniformLocation(program, 'iTime');
  locHue = gl.getUniformLocation(program, 'uHue');
  locXOffset = gl.getUniformLocation(program, 'uXOffset');
  locSpeed = gl.getUniformLocation(program, 'uSpeed');
  locIntensity = gl.getUniformLocation(program, 'uIntensity');
...
const render = () => {
  ...
  gl.uniform1f(locIntensity, props.intensity);
